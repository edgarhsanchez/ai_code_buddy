...
impl CodeAnalyzer {
    ...
    fn initialize_rust_patterns(&mut self) {
        ...
        self.rust_patterns.insert(
            r"\.unwrap\(\)".to_string(),
            (IssueCategory::PotentialBugs, Severity::Medium, 
             "Consider using proper error handling instead of unwrap()".to_string())
        );
        
        self.rust_patterns.insert(
            r"\.expect\([^)]*\)".to_string(),
            (IssueCategory::PotentialBugs, Severity::Low,
        ...
        self.rust_patterns.insert(
            ...
            (IssueCategory::Style, Severity::Low,
        ...
        self.rust_patterns.insert(
            ...
            (IssueCategory::Maintainability, Severity::Low,
    ...
    fn initialize_general_patterns(&mut self) {
        ...
        self.general_patterns.insert(
            ...
            (IssueCategory::Documentation, Severity::Low,
        ...
        self.general_patterns.insert(
            r"#\[test\]".to_string(),
            (IssueCategory::Testing, Severity::Info,
    ...
    fn analyze_file_structure(&self, content: &str, file_path: &str) -> Vec<CodeIssue> {
        ...
        for (line_num, line) in lines.iter().enumerate() {
            ...
            if indent_level > 24 { // More than 6 levels of indentation (4 spaces each)
                issues.push(CodeIssue {
                    ...
                    file_path: file_path.to_string(),
                    line_number: Some((line_num + 1) as u32),
                    suggestion: "Consider extracting nested logic into separate functions".to_string(),
                    code_snippet: Some(line.to_string()),
                });
            }
        }
